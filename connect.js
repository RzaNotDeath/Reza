...
//PAIRING CODE BY HARDZOFFC

CFonts.say("SC PAIRING BY HARDZ OFFCIAL", {
   font: 'chrome',
  align: 'left',
  gradient: ['red', 'magenta'],
});
CFonts.say(
  "Sc Bot By HardzSenpaii\nBase: RafatharOffcial\nRecodeBy : HardzSenpaii\nRuning : Panel\n\n\nSc Ini Di Recode HardzOfc, Kalo Ketahuan Bagiiin Secara Free Sc Ini ,Gua Santet Nyawa Lu Jarak Jauh Sampe Mati Ditempat\n\n\n",
  {
    colors: ["system"],
    font: "console",
    align: "center",
...
//await sleep(400)  
console.log(color(`─[`,`magenta`),`「`,  color(`HARDZ OFFC`,`red`), `」`,  color(`]─`,`magenta`))
//await sleep(400)  
start(`1`,`Connecting...`)
